...
insert into role(id, application_name, role_name, description)
values (102020121100000003, 'AccountManagement', 'APPRW', '应用读写角色');
insert into role(id, application_name, role_name, description)
values (102020121100000004, 'AccountManagement', 'APPRAU', '应用读、新增、修改权限');
insert into role(id, application_name, role_name, description)
values (102020121100000005, 'AccountManagement', 'APPR', '应用只读角色');
...
values (102020121100000006, 'AccountManagement', 'ALL', '系统所有权限');
insert into permission(id, application_name, permission_name, description)
values (102020121100000007, 'AccountManagement', 'APP_ALL', '应用所有权限，可以对应用数据进行所有类型操作');
insert into permission(id, application_name, permission_name, description)
values (102020121100000008, 'AccountManagement', 'APP_RW', '应用写权限，包括新增、修改、删除');
insert into permission(id, application_name, permission_name, description)
values (102020121100000009, 'AccountManagement', 'APP_RA', '应用新增权限');
insert into permission(id, application_name, permission_name, description)
values (102020121100000010, 'AccountManagement', 'APP_RU', '应用修改权限');
insert into permission(id, application_name, permission_name, description)
values (102020121100000011, 'AccountManagement', 'APP_RD', '应用删除权限');
insert into permission(id, application_name, permission_name, description)
values (102020121100000012, 'AccountManagement', 'APP_R', '应用只读权限');

insert into role_permission(role_id, permission_id)
values (102020121100000001, 102020121100000006);
insert into role_permission(role_id, permission_id)
values (102020121100000002, 102020121100000007);
insert into role_permission(role_id, permission_id)
values (102020121100000003, 102020121100000008);
insert into role_permission(role_id, permission_id)
values (102020121100000004, 102020121100000012);
insert into role_permission(role_id, permission_id)
values (102020121100000004, 102020121100000009);
insert into role_permission(role_id, permission_id)
